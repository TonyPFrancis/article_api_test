...
def test_url():
    ...
    crawled_item = {'url': 'https://www.bbc.com/news/science-environment-61383391', 'source_name': 'BBC News',
                    'source_logo': 'https://www.bbc.co.uk/news/special/2015/newsspec_10857/bbc_news_logo.png?cb=1',
